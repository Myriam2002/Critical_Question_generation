...
for model_name in models:
    ...
    for selected_prompt_name in selected_prompt_names:
        target_file = f'testing_dataset_output_{selected_prompt_name}_{model_name_in_file}.json'
        print("Starting", target_file)
        result_file_name = f'testing_output_{selected_prompt_name}_{model_name_in_file}_eval_similarity_0.6.json'
